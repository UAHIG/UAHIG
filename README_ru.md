...
Front-End разработчик с опытом более 2 лет, создающий решения как для удалённых, так и для офисных проектов.

Имею опыт полного цикла разработки — от сбора требований и проектирования UI/UX до реализации адаптивного дизайна, доступности и высокого покрытия тестами. Специализируюсь на создании масштабируемых приложений на React, Redux и TypeScript с акцентом на производительность и чистую архитектуру.

Увлекаюсь современными веб-технологиями, дизайн-системами и новыми инструментами разработки с использованием AI. Люблю писать технические статьи, вносить вклад в open-source и демонстрировать свои работы потенциальным клиентам.
