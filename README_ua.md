...
Front-End розробник із понад 2-річним досвідом, який реалізує рішення як для віддалених, так і для офлайн-проєктів.

Маю досвід повного циклу розробки — від збору вимог і проєктування UI/UX до впровадження адаптивного дизайну, доступності та високого покриття тестами. Спеціалізуюся на створенні масштабованих застосунків на React, Redux і TypeScript з фокусом на продуктивність і чисту архітектуру.

Захоплююся сучасними вебтехнологіями, дизайн-системами та новими інструментами розробки з підтримкою AI. Із задоволенням пишу технічні статті, роблю внесок в open-source та презентую свої роботи потенційним клієнтам.
